...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['pct_correct_dogs'] =  (results_stats_dic['n_correct_dogs'] /(results_stats_dic['n_correct_dogs']+results_stats_dic['n_correct_notdogs']))*100.0
    #Calculates % correct breed of dog
    results_stats_dic['pct_correct_breed'] = (results_stats_dic['n_correct_breed']/results_stats_dic['n_correct_dogs'])*100.0
