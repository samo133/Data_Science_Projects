    ...
    for key in results_stats:
        if key[0] == "p":
            ...
            for (key, value) in results_stats.items(): 
                sum += value
                percent = results_stats[key] / float(sum)
                print( "percentage of '%20s' is %3d %%".format( percentage*100))
    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            ...
            if sum(results_dic[key][3:]) == 1:
                print("Real: <%26s   Classifier: <%30s" .formaat(results_dic[key][0],
                                                          results_dic[key][1]))
    ...
    if (print_incorrect_breed and 
        ...
        for key in results_dic:
            ...
            if ( sum(results_dic[key][3:]) == 2 and
                results_dic[key][2] == 0 ):
                print("Real: %-26s   Classifier: %-30s".format (results_dic[key][0],
                                                          results_dic[key][1]))
