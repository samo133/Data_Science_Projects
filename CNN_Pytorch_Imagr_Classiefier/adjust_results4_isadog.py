...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    for key in results_dic:
        ...
        # appends (1) because both labels are dogs else add (0)
        # Classifier Label IS NOT image of dog (e.g. NOT in dognames_dic)
        # appends (1 because only pet label is a dog  else add (0)
        ...
        if results_dic[key][1] in dognames_dic:
            ...
            Dog_breed = 0
        results_dic[key].append(Dog_image)
        results_dic[key].append(Dog_breed)
